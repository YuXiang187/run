...
解：(1)∵指数函数 ∴ $\begin{cases}k+3=1\\3-b=0\end{cases}\therefore\begin{cases}k=-2\\b=3\end{cases}$
...
1. a>1时， $y=\log_2 x$ ， $2^y=x$

   ![i](./assets/28.jpg)

2. a<1时， $y=\log_\frac{1}{2} x$ ， $(\frac{1}{2})^y=x$
...
1. k=0时，5>0，恒成立
2. k≠0时， $\begin{cases}k>0\\\Delta=4k(4k-5)<0\end{cases}$ ， $\therefore 0<k<\frac{5}{4}$
...
$b=\log_2 3\Leftrightarrow 2^b=3,b<2<a$
