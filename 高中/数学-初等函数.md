...
例：定义 $f(x)=\sqrt{x}$ ，那么 $f(g(x))=f(g(\sqrt{x}))$

---

换元法示例：设 $2x=t$ ，则 $x=\frac{1}{2}t$ ， $x^2=\frac{1}{4}t^2$

$f(2x)=x^2=\frac{1}{4}\cdot (2x)^2\Leftrightarrow f(t)=\frac{1}{4}t^2\Leftrightarrow f(x)=\frac{1}{4}x^2$

$f(3x)=?=\frac{1}{4}\cdot (3x)^2$

---

解析式考点： $f(x)=\sqrt{x},g(x)=\frac{1}{x}$

$f(g(x))=\sqrt{\frac{1}{x}}$

当x递增，g(x)递减，f(g(x))递减
